...
export default function TestimonialsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] text-[#1F1E1B] font-sans antialiased">
      ...
      <div className="py-16 bg-[#FAF8F5] border-b border-[#E8E4DC]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="font-serif text-4xl sm:text-6xl font-normal text-[#1F1E1B] mt-2 mb-4">
            The ገልጋይ (Gelgay) Ledger
          </h1>
          <p className="font-sans text-base text-[#625D54] max-w-2xl mx-auto font-light leading-relaxed">
            Real stories from buyers and curators across Posta Bet, Geda, Boku Shenen, and Adama.
          </p>
        </div>
      </div>
      ...
      <PageNavigationFlow
        breadcrumbs={[{ label: 'Stories & Ledger' }]}
        prev={{ label: 'Buyer Protection', sublabel: 'Escrow verification protocols', href: '/buyer-protection' }}
        next={{ label: 'About ገልጋይ', sublabel: 'The Architecture of Longevity manifesto', href: '/about' }}
      />
