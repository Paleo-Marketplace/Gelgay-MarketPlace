...
export default function FAQPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] text-[#1F1E1B] font-sans antialiased">
      ...
      <PageNavigationFlow
        breadcrumbs={[{ label: 'FAQ & Protocols' }]}
        prev={{ label: 'About ገልጋይ', sublabel: 'Learn about our philosophy & inspection standards', href: '/about' }}
        next={{ label: 'Shop the Archive', sublabel: 'Start exploring verified items and pieces', href: '/shop' }}
      />
